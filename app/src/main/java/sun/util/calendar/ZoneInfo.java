 ...
 * have any questions.
 */
//PJPJPJPJPJPJ just here to allow deserialize of the Compass model
 ...
 * TimeZone TimeZone} that represents GMT offsets and
 ...
 * operations to a {@link SimpleTimeZone SimpleTimeZone}
...
//    private static final CalendarSystem gcal = CalendarSystem.getGregorianCalendar();
     ...
     * {@link SimpleTimeZone#SimpleTimeZone(int, String,
     * int, int , int , int , int , int , int , int , int) the
     * 11-argument SimpleTimeZone constructor} or 10 for {@link
     * SimpleTimeZone#SimpleTimeZone(int, String, int, int,
     * int , int , int , int , int , int , int, int, int) the
