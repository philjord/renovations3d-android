...
/**
 * PJPJ android resource bundles default to UTF8! java demands ISO8859, so a custom control added , new ISO8859FileControl()
 *
 *
...
public class DefaultTexturesCatalog extends TexturesCatalog {
  ...
  public DefaultTexturesCatalog(URL [] pluginTexturesCatalogUrls,
    ...
    try {
      ...
      for (URL pluginTexturesCatalogUrl : pluginTexturesCatalogUrls) {
        try {
          ResourceBundle resource = ResourceBundle.getBundle(PLUGIN_TEXTURES_CATALOG_FAMILY, Locale.getDefault(),
              new URLContentClassLoader(pluginTexturesCatalogUrl), new ISO8859FileControl());
      ...
      ResourceBundle resource = ResourceBundle.getBundle(PLUGIN_TEXTURES_CATALOG_FAMILY, Locale.getDefault(), new ISO8859FileControl());
  ...
  private void readPluginTexturesCatalog(File pluginTexturesCatalogFile,
    ...
    try {
      ...
      ResourceBundle resourceBundle = ResourceBundle.getBundle(PLUGIN_TEXTURES_CATALOG_FAMILY, Locale.getDefault(), urlLoader, new ISO8859FileControl());
  ...
  private void readTexturesCatalog(final String texturesCatalogFamily,
    ...
    if (preferences != null) {
      ...
      try {
        resource = ResourceBundle.getBundle(texturesCatalogFamily, new ISO8859FileControl());
      } catch (MissingResourceException ex) {
        return;
      }
    }
