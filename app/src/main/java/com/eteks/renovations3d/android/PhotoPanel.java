...
import com.eteks.renovations3d.android.swingish.JSpinnerDate;
import com.eteks.renovations3d.android.swingish.SpinnerDateModel;
...
public class PhotoPanel extends AndroidDialogView implements DialogView {
  ...
  private void stopPhotoCreation(final boolean confirmStop) {
    ...
    if (photoCreationExecutor != null
      ...
      if (photoCreationExecutor != null) { // Check a second time in case rendering stopped meanwhile
  ...
  private void savePhoto() {
    ...
    try {
      if (pngFile != null) {
        ImageIO.write(photoComponent.getImage(), "PNG", new File(pngFile));
